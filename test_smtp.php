 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	$from="pawprints@baylor.edu";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="joseph_rafferty@baylor.edu";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
	...
	$smtp->host_name="smtpserver";       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->workstation="gus";              /* Workstation name for NTLM authentication */
